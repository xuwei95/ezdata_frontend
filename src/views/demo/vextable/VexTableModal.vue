        ...
        <a-form ref="formRef" :model="orderMainModel" :label-col="labelCol" :wrapper-col="wrapperCol" :rules="validatorRules">
            ...
            <a-tabs defaultActiveKey="1">
                <a-tab-pane tab="客户信息" key="1">
                    ...
                    <vxe-table border show-overflow keep-source ref="xTable" max-height="400" :data="orderMainModel.jeecgOrderCustomerList" :edit-config="{trigger: 'click', mode: 'row', icon: 'fa fa-pencil', showStatus: true}">
